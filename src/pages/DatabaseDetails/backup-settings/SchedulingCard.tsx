      ...
      >
        ...
        <div>
          ...
          <input
            ...
            className={`w-full border border-gray-200 dark:border-neutral-700 rounded px-3 py-2 bg-white dark:bg-neutral-950 text-gray-900 dark:text-gray-100 ${editing && enabled && !isLocalStorage ? "opacity-100" : "opacity-60 cursor-not-allowed"
              }`}
          />
