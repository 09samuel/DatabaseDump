...
import AuditLogsCard from "../../AuditLogs/components/AuditLogsCard";
import type { AuditLog } from "../../AuditLogs/types";
import { fetchAuditLogsByConnection } from "../../../services/audit-logs.service";
...
function DatabaseAuditLogsTab() {
    ...
    const [loadingMore, setLoadingMore] = useState(false);
        ...
        const fetchLogs = useCallback(async () => {
            ...
            try {
            const res = await fetchAuditLogsByConnection(id, {
        ...
        }, [id, filters.actionCategory, filters.actionType, filters.status, dateParams.from, dateParams.to, sortDirection]);
        ...
        return (
            ...
            <div className="grid grid-cols-1 gap-4 md:pr-3 mb-4 pb-24 md:pb-0 overflow-y-auto">
                ...
                {logs.length > 0 &&
                logs.map((log) => <AuditLogsCard key={log.id} {...log} />)}
        ...
        export default DatabaseAuditLogsTab;
