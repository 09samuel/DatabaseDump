...
function DeleteDatabaseModal({ dbId, dbName, onClose, onSuccess }: DeleteDatabaseModalProps) {
    ...
    return (
        ...
        >
            <div className="flex flex-col items-center gap-6 bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 p-6 rounded-lg shadow-lg w-96 z-50 ">
                <span className="text-gray-900 dark:text-gray-100">Do you really want to delete database {dbName}?</span>
